...
import { IconAlertTriangle, IconFlag, IconCalendar, IconClock } from '@tabler/icons-react';
...
export default function PassengerIncidentReports() {
  ...
  // Sample incident reports submitted by this passenger
  const incidentReports: IncidentReport[] = [
    ...
    {
      id: 'INC-004',
      timestamp: new Date('2023-08-10T22:10:00'),
      ...
      <CardHeader className="pb-2">
        <div className="flex justify-between items-start">
          <div>
            ...
            <CardDescription>Reports submitted by this passenger</CardDescription>
          </div>
      ...
      <CardContent>
        {incidentReports.length === 0 ? (
          <div className="py-8 text-center text-muted-foreground">
            No incident reports submitted by this passenger
          </div>
        ) : (
          <>
